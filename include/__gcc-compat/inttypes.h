...
//
//===----------------------------------------------------------------------===//
#ifndef LLVM_LIBC_GCC_COMPAT_INTTYPES_H
#define LLVM_LIBC_GCC_COMPAT_INTTYPES_H

#include <stdint.h>
__BEGIN_C_DECLS
intmax_t wcstoimax(const wchar_t *__restrict, wchar_t **__restrict, int) __NOEXCEPT;
uintmax_t wcstoumax(const wchar_t *__restrict, wchar_t **__restrict, int) __NOEXCEPT;
__END_C_DECLS

#endif // LLVM_LIBC_GCC_COMPAT_INTTYPES_H
